...
class UsbHexImporterView(AbstractFileImporterView):

    GLADE_FILENAME = "UsbHexImportConfigurationWidget.glade"

    def __init__(self, plugin, controller):
        super(UsbHexImporterView, self).__init__(plugin, controller)

        # Import and add configuration widget
        self.builderConfWidget = Gtk.Builder()
        curDir = os.path.dirname(__file__)
        gladePath = os.path.join(self.getPlugin().getPluginStaticResourcesPath(), "ui", UsbHexImporterView.GLADE_FILENAME)
        ...
        self.setDialogTitle(_("Import messages from UsbHex file"))
