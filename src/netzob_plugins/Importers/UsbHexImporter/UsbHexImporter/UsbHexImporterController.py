...
from UsbHexImporter import UsbHexImporter
from UsbHexImporterView import UsbHexImporterView


class UsbHexImporterController(AbstractFileImporterController):
    COLUMN_ID = 1
    COLUMN_SELECTED = 0

    def __init__(self, netzob, plugin):
        view = UsbHexImporterView(plugin, self)
        super(UsbHexImporterController, self).__init__(netzob, plugin, view)
        self.model = UsbHexImporter(netzob)
